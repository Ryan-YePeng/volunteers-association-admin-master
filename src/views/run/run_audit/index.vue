<template>
  <el-card class="box-card">
    <div slot="header" class="clearfix">
      <span>审核列表</span>
      <el-button class="float-right ml-5" type="danger" icon="el-icon-delete" @click="rejectMore">批量拒绝</el-button>
      <el-button class="float-right" type="success" icon="el-icon-check" @click="passMore">批量通过</el-button>
    </div>
    <div>
