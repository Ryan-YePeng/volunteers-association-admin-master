<template>
  <el-card class="box-card">
    ...
    <add-ended-activity ref="AddEndedActivity" :dept="tree" @update="getJobList"></add-ended-activity>
    <edit-ended-activity ref="EditEndedActivity" :dept="tree" @update="getJobList"></edit-ended-activity>
  </el-card>
</template>
...
<script>
  ...
  import AddEndedActivity from './add'
  import EditEndedActivity from './edit'
  import {objectEvaluate} from "@/utils/common";

  export default {
    name: "EndedActivity",
    components: {EditEndedActivity, AddEndedActivity},
    data() {
      return {
    ...
    methods: {
      ...
      add() {
        let _this = this.$refs.AddEndedActivity;
        _this.visible = true
      },
      edit(obj) {
